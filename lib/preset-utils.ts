...
export function createTopMarketFilters(data: ComparisonData | null): Partial<FilterState> {
  if (!data) {
    console.warn('⚠️ createTopMarketFilters: No data provided')
    return {
  ...
  console.log('🎯 Top Market Filters:', {
    topRegions,
    topRegionsCount: topRegions.length,
    firstSegmentType,
    firstLevelSegments: firstLevelSegments.slice(0, 5),
    firstLevelSegmentsCount: firstLevelSegments.length,
    hasData: !!data,
...
export function createGrowthLeadersFilters(data: ComparisonData | null): Partial<FilterState> {
  ...
  console.log('🎯 Growth Leaders Filters:', {
    topRegions,
    firstSegmentType,
    firstLevelSegments: firstLevelSegments.slice(0, 5),
    hasData: !!data
...
export function createEmergingMarketsFilters(data: ComparisonData | null): Partial<FilterState> {
  ...
  console.log('🎯 Emerging Markets Filters:', {
    topCountries,
    firstSegmentType,
    firstLevelSegments: firstLevelSegments.slice(0, 5),
    hasData: !!data
